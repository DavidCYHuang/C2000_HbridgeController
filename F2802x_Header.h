...
#define Device_cal (void   (*)(void))0x3D7C80          // The following pointer to a function call calibrates the ADC and internal oscillators

#define getTempSlope() (*(int (*)(void))0x3D7E80)()    //Slope of temperature sensor (deg. C / ADC code, fixed pt Q15 format)

#define getTempOffset() (*(int (*)(void))0x3D7E83)()   //ADC code corresponding to temperature sensor output at 0-degreesC
